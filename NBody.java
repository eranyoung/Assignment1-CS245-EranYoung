...
public class NBody{
    ...
    public static void main(String[] args) {
        NBodyList list = new NBodyList(args[0]);
        new NBody(list);
    }
    ...
    public class NBodyPane extends JPanel {
        ...
        public void calcNewVeloc(){
        	for(int i = 0; i < list.size(); i++){
        		...
        		iNode.setXVeloc(list.get(i).getXVeloc() + accelerationX/list.scale());
        		iNode.setYVeloc(list.get(i).getYVeloc() + accelerationY/list.scale());
        ...
        protected void moveBodies(){
        	this.calcNewVeloc();
            for(int i = 0; i < list.size(); i++){
            	list.get(i).setX( list.get(i).getX() + list.get(i).getXVeloc());
            	list.get(i).setY( list.get(i).getY() + list.get(i).getYVeloc());
            }
        }
